...
type ApiClientType = InitClientReturn<typeof contract, { baseUrl: 'http://localhost:3001/'; throwOnUnknownStatus: true }>;
...
export const ApiClientContextProvider = ({ children }: { children: ReactNode }) => {
    const [tokens, setTokens] = useState<{ accessToken: string; refreshToken: string } | { accessToken: undefined; refreshToken: undefined }>({
